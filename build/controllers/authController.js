...
class AuthController {
    login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const infoUsuario = yield database_1.default.query(`
        ...
        WHERE t0.id = ? AND t2.id = ? AND t0.status ='A' AND t2.status ='A'`, [user[0].id, user[0].companyid]);
            const perfilesUsuario = yield database_1.default.query(`SELECT t0.id, t0.perfil 
                                                FROM perfiles t0 
                                                INNER JOIN perfil_users t1 ON t1.id_perfil = t0.id 
                                                WHERE t1.id_user = ?`, [user[0].id]);
            const opcionesMenu = yield database_1.default.query(`SELECT t0.* 
                                            FROM menu t0 
            ...
            const opcionesSubMenu = yield database_1.default.query(`SELECT t0.* 
                                                FROM menu t0 
                                                INNER JOIN perfil_menu_accions t1 ON t1.id_menu = t0.id 
                                                WHERE t1.id_perfil IN (SELECT t10.id FROM perfiles t10 INNER JOIN perfil_users t11 ON t11.id_perfil = t10.id WHERE t11.id_user = ?) AND
                                                    t0.hierarchy ='H' AND
    ...
    dependenciesUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(bdmysql);
            const dependenciasUsuario = yield database_1.default.query(`SELECT * FROM ${bdmysql}.dependencies_user WHERE codusersap = '${infoUsuario.codusersap}'`);
    ...
    areasSolpedUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bdmysql = infoUsuario.bdmysql;
            console.log(bdmysql);
            const dependenciasUsuario = yield database_1.default.query(`SELECT * FROM ${bdmysql}.areas_user WHERE codusersap = '${infoUsuario.codusersap}'`);
            console.log(dependenciasUsuario);
            res.json(dependenciasUsuario);
        });
    }
    almacenUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bdmysql = infoUsuario.bdmysql;
            console.log(bdmysql);
            const dependenciasUsuario = yield database_1.default.query(`SELECT * FROM ${bdmysql}.stores_users WHERE codusersap = '${infoUsuario.codusersap}'`);
            console.log(dependenciasUsuario);
            res.json(dependenciasUsuario);
        });
    }
