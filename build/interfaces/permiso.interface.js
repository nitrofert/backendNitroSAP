...
exports.Convert = exports.Perfil = void 0;
var Perfil;
(function (Perfil) {
    Perfil["Administrador"] = "Administrador";
    Perfil["AsitenteDeCompras"] = "Asitente de compras";
})(Perfil = exports.Perfil || (exports.Perfil = {}));
// Converts JSON strings to/from your types
// and asserts the results of JSON.parse at runtime
class Convert {
    static toPermisosInterface(json) {
        return cast(JSON.parse(json), a(r("PermisosInterface")));
    }
    static permisosInterfaceToJson(value) {
