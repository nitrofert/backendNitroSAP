...
class SolpedRoutes{
    ...
    config():void{
        ...
        this.router.post('/aprobacion',solpedController.aproved_portal3);
        ...
        this.router.get('/list/mps/:status', solpedController.listMPS4);
        this.router.get('/list/documentsTracking', solpedController.documentsTracking);
        ...
        this.router.post('/enviar-sap',solpedController.enviarSolpedSAP2);
